    ...
    <section id="contact" className="py-24 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">Jsme tu pro Vás</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <a href="mailto:info@paytech.cz" className="hover:text-blue-600">
                      info@paytech.cz
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg flex flex-col items-center justify-center text-center">
              <h3 className="text-2xl font-bold mb-4">Začněte s PayTech ještě dnes</h3>
              <p className="text-gray-600 mb-8">
                Připojte se k tisícům spokojených podnikatelů a začněte šetřit na poplatcích
              </p>
              <button className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition flex items-center gap-2">
                Registrovat nyní
