        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <div className="space-y-4">
              {[
                { icon: <CreditCard className="w-6 h-6" />, text: 'Platba kartou od 0,6 % transakčního poplatku' },
                { icon: <Wifi className="w-6 h-6" />, text: 'Připojení přes Wi-Fi nebo mobilní data, funguje kdekoliv' },
                { icon: <Clock className="w-6 h-6" />, text: 'Rychlá aktivace během několika minut' },
                { icon: <CheckCircle className="w-6 h-6" />, text: 'Podpora všech běžných platebních karet a moderních technologií' }
              ].map((item, index) => (
